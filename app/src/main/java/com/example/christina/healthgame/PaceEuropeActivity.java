...
public class PaceEuropeActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_europepace);
    ...
    public void fivePage(){
        Intent intent = new Intent(this, easyFiveEurope.class);
